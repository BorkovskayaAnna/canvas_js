...
if (canvas.getContext) {
    ...
    canvas.width = document.querySelector('.container').clientWidth - 60;
    canvas.height = document.querySelector('.container').clientHeight - 60;
...
// listen for mouse events
    ...
    rectsArr.push(new Rect(1, 1, 100, 50, 'purple'));
    rectsArr.push(new Rect(1, 90, 150, 60, 'blue'));
    rectsArr.push(new Rect(1, 190, 200, 80, 'green'));
    rectsArr.push(new Rect(1, 300, 100, 50, 'yellow'));
    ...
    function drawRect() {
        ...
        for (let i in rectsArr) {
            ...
            ctx.fillStyle = current.isOverlapping ? "red" : current.fill;
